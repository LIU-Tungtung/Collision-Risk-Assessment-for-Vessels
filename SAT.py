...
def separating_axis_theorem_circle(vertices_a, vertices_b):
    result = math.sqrt( math.pow( (vertices_a[0][0] - vertices_b[0][0]), 2 ) + math.pow( (vertices_a[0][1] - vertices_b[0][1]), 2 ) )
    result *= (60 * 1852) # 米
    return True if result < vertices_a[0][2] + vertices_b[0][2] else False